...
export default function GroupChatInterface() {
  ...
  const moreMenuRef = useClickOutside(() => setShowMoreMenu(false));
  ...
  function handleDraftChange(e) {
    ...
    // auto-grow the textarea up to 5 lines, then let it scroll internally
    const el = e.target;
  ...
  return (
    <div className="lc-root">
      <style>{`
        ...
        .lc-composer { border-top:1px solid var(--border); padding:10px 16px; display:flex; align-items:flex-end; gap:6px; flex-shrink:0; position:relative; }
        .lc-composer .lc-icon-btn, .lc-composer .lc-send { flex-shrink:0; }
        .lc-composer-textarea { flex:1; min-width:0; padding:9px 12px; font-size:14px; font-family:inherit;
      ...
      {(showGroups || showInfo) && (
        <div className="lc-backdrop" onClick={() => { setShowGroups(false); setShowInfo(false); }} />
      )}
      <GroupList
        groups={myGroups}
      ...
      <div className="lc-center">
        <div className="lc-header">
          ...
          <div style={{ position: "relative" }}>
            ...
            {showMoreMenu && (
              <div className="lc-more-menu" ref={moreMenuRef}>
        ...
        <div className="lc-composer">
          ...
          {showEmoji && (
            <div className="lc-emoji-pop" ref={emojiRef}>
          ...
          <textarea
            ref={textareaRef}
            className="lc-composer-textarea"
